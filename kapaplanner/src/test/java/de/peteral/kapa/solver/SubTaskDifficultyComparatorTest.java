...
public class SubTaskDifficultyComparatorTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][] {
                {null, 0, null, 0, 0},
                {"x", 0, null, 0, Integer.MIN_VALUE},
                {null, 0, "x", 0, Integer.MAX_VALUE},
                {"a", 0, "b", 0, -1},
                {"b", 0, "a", 0, 1},
                {"a", 0, "a", 0, 0},
                {"a", 0, "a", 1, 1},
    ...
    public SubTaskDifficultyComparatorTest(String due1, int cost1, String due2, int cost2, int expected) {
        this.due1 = due1;
        this.cost1 = cost1;
        this.due2 = due2;
        this.cost2 = cost2;
